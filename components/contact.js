    ...
    return(
        <div className="contact" id="contact">
            <div className="w-full h-full m-auto">
                <h1 className="text-2xl font-bold flex justify-center mb-10">contact</h1>
                <span className=" text-blue-700 font-mono text-2xl flex justify-center mb-10"> you can send me an email(wei9912@gmail.com), or use the contact from below</span>
                <form className="rounded-lg shadow-xl flex flex-col px-8 py-8 bg-white dark:bg-blue-500" onSubmit={handleSubmit}>
                    ...
                    name="fullname" className="bg-transparent border-b py-2 pl-4 focus:outline-none focus:rounded-md focus:ring-1 ring-green-500 font-light text-gray-500" />
